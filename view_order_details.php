...
<title>View Order | Sude Bakery</title>
...
<li><a href="view_order_details.php"class="active"  style="font-weight: 400;"><i class="fa fa-star"style="color:#dddcda;" ></i> Order Details</a></li>
...
<td class="image" style="min-width: 200px;text-align: center;">Photo</td>
<td class="description" style="min-width: 150px;text-align: center;">Item Name</td>
<td class="price"style="min-width: 100px;text-align: center;">Price</td>

<td class="description" style="min-width: 200px;text-align: center;">Customer</td>
<td class="description" style="min-width: 200px;text-align: center;">Address</td>
...
$sql1 = "SELECT * FROM products WHERE F_ID='".$row['F_ID']."'";
...
$row1 = mysqli_fetch_assoc($result1);
    ...
    <tr>
      ...
      <td class="cart_price"style="min-width: 100px;text-align: center;"><p><?php echo $count;?></p></td>
       <td class="cart_product"style="min-width:200px;text-align: center;">
      <a href=""> <img src="  <?php echo $row1["images_path"]; ?> " style="width: 200px;height: 200px;"></a> 

       </td>
      <td class="cart_description"style="min-width:150px;text-align: center;"><p><?php echo $row["foodname"]; ?></p></td>
      <td class="cart_price"style="min-width: 100px;text-align: center;"><p><?php echo $row["price"]; ?></p></td>


      <td class="cart_description"style="min-width: 200px;text-align: center;max-width:200px;"><p>  

     <?php echo $row["username"]; ?></p></td>
  

   <td class="cart_description"style="min-width: 200px;max-width:200px;text-align: center;"><p><?php echo $row["Address"]; ?></p></td>
    </tr>
