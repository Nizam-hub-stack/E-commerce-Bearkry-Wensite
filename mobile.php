...
<title>Mobiles | Sude Bakery</title>
...
<li><a href="mobile.php" class="active" style="font-weight: 400"><i class="fa fa-star"></i> Pizza & Burger</a></li>
<li><a href="desktop.php"  style="font-weight: 400"><i class="fa fa-star"></i> Cakes & Bread</a></li>
<li><a href="laptop.php"  style="font-weight: 400"><i class="fa fa-star"></i> Breakfast & Snacks</a></li>
...
<div class="col-sm-6">
<img src="a3.jpg" class="girl img-responsive" style="max-height: 320px;"  alt="" />
...
$sql = "SELECT * FROM products WHERE description='Pizza & Burger' ORDER BY F_ID DESC";
...
<img src="<?php echo $row["images_path"]; ?>" style="width:300px;height: 300px;"   alt="" />
