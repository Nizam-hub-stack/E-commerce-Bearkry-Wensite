...
<title>Desktop | Sude Bakery</title>
...
<li><a href="desktop.php" class="active" style="font-weight: 400"><i class="fa fa-star"></i> Cakes & Bread</a></li>
...
$sql = "SELECT * FROM products WHERE description='Cakes & Bread' ORDER BY F_ID";
